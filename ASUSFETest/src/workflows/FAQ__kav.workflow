...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <alerts>
        <fullName>Email_Knowledge_Group_for_Graduate_Admissions_Article_Published</fullName>
        <description>Email Knowledge Group for Graduate Admissions: Article Published</description>
        <protected>false</protected>
        <recipients>
    ...
    <alerts>
        <fullName>Email_Knowledge_Group_for_Univ_Housing_Article_Published</fullName>
        <description>Email Knowledge Group for Univ Housing: Article Published</description>
        <protected>false</protected>
        <recipients>
    ...
    <knowledgePublishes>
        ...
        <description>Action publishes FAQ articles.</description>
